...
int main (int argc, char **argv)
{
    ...
    {
    { "new-instance", 'i', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &new_instance, ("Open a new instance"), NULL },
    { "no-plugins", 'n', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &no_plugins, ("Do not load plugins"), NULL },
    { "device", 'd', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_STRING, &device, ("Set Audio-CD/VCD/DVD device path"), NULL },
    { "embedded", 'E', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &embedded, ("Start in embedded mode"), NULL },
    { "fullscreen", 'F', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &fullscreen, ("Start in fullscreen mode"), NULL },
    { "play", 'p', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &play, ("Play or pause if already playing"), NULL },
    { "next", 'N', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &next_track, ("Next track"), NULL },
    { "previous", 'P', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &prev_track, ("Previous track"), NULL },
    { "volume-up", 'r', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &raise_volume, ("Raise volume"), NULL },
    { "volume-down", 'l', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &lower_volume, ("Lower volume"), NULL },
    { "mute", 'm', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &mute, ("Mute volume"), NULL },
    { "unmute", 'u', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &unmute, ("Unmute (restore) volume"), NULL },
    { "add", 'a', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &enqueue, ("Add files to playlist"), NULL},
    { "version", 'V', G_OPTION_FLAG_IN_MAIN, G_OPTION_ARG_NONE, &version, ("Print version information and exit"), NULL },
    { "sm-client-id", 0, G_OPTION_FLAG_HIDDEN, G_OPTION_ARG_STRING, &client_id, NULL, NULL },
    {G_OPTION_REMAINING, '\0', 0, G_OPTION_ARG_FILENAME_ARRAY, &filenames, ("Media to play"), NULL},
        { NULL, },
    };
...
//    xfce_textdomain (GETTEXT_PACKAGE, LOCALEDIR, "UTF-8");
    ...
    ctx = g_option_context_new (("[FILES...] - Play movies and songs"));
    ...
    if ( !new_instance && parole_dbus_name_has_owner (PAROLE_DBUS_NAME) )
    {
        ...
        if (!enqueue && !play && !next_track && !prev_track && 
            ...
            g_print (("Parole is already running, use -i to open a new instance\n"));
